                ...
                <table class="policies-table">
                    ...
                    <tbody>
                        ...
                        <tr class="<?php echo $row_class; ?>" data-policy-id="<?php echo $policy->id; ?>">
                            ...
                            <td class="representative" data-label="Temsilci"><?php echo !empty($policy->representative_name) ? esc_html($policy->representative_name) : '—'; ?></td>
...
if (isset($_GET['action'])) {
    ...
    if (in_array($action_param, array('view', 'new', 'edit', 'renew', 'cancel'))) {
        ...
        } elseif (in_array($action_param, array('edit', 'renew')) && $policy_id_param > 0) {
            $include_file = 'policies-form-edit.php';
        } elseif (in_array($action_param, array('new', 'cancel'))) {
